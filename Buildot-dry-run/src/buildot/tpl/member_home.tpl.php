...
function hidebox(id){
	...
	//alert(document.getElementById('replytext'+id).innerHTML);
  ...
  <table cellpadding="0" cellspacing="0">
    <tr>
      ...
      <table width="100%" border="0" cellspacing="0" cellpadding="0" id="general_table">
          <tr>
            <td><form method="post" id="form1" enctype="multipart/form-data">
                <table cellpadding="0" cellspacing="0" border="0" width="50%" class="comment_box">
                  ...
                  <tr>
                   ...
                   <td style="width:80px;"><input type="image" value="Post" src="images/post-btn.png" style="padding-top: 5px;" width="46" height="23" /></td>
                    <td style="width:80px;"><input type="reset" value="Cancel" class="cancel_btn" /></td>
                    <td style="width:631px;"><div id="FileUpload">
                        <input type="file" style="width:100px;" name="image" id="BrowserHidden" onchange="return attachfile()" size="1" />
          ...
          <tr>
            <td><table cellpadding="0" cellspacing="0" width="100%" align="left" id="member_home_page">
		...
		if(!empty($update['logo'])) { ?>
                    ...
                    <?php }?></td></tr></table></td>
                  <td width="477"><div class="comment" style="height:30px">
...
<?php } ?>
		...
		if($replyCount <3 || $_REQUEST['reply'] == 1){?>
                    <div style="margin-top:20px">
                      ...
                      <a href="index.php?view=member_home&delete=1&memberId=<?php echo $update['member_id'] ?>&reply_id=<?php echo $reply['reply_id']?>"><span style="float: right; padding-top: 5px;"><img src="<?=IMAGEURL?>icons/close.gif" /></span></a><br />
                      <?php } ?>
                     ...
                     <div style="width: 200px; padding-left: 88px; font-size:8pt; color: #999; background: url(images/icons/time.png) no-repeat 70px;"><?=compare_dates($reply['curunixtime'],$reply['createdunixtime'])?></div>
                      <br /> <br />
					  </div>
                      <?php }}?>
...
$('document').ready(function()
{
	$('#formMemHome<?=$co?>').ajaxForm(  {
		...
		//$('#formbox').slideUp('fast');
                      ...
                      <form method="post" id="formMemHome<?=$co++?>" action="">
