...
<tr>
<td width="87%"><h2>MEMBER DETAILS</h2></td>
</tr>
</table>
<br />
<table cellpadding="0" cellspacing="0" width="97%" align="left" id="member_home_page">
<tr class="blue-gradient-bg">
<td width="176" valign="top"><div>
...
<img src="gallery/logos/thumbs/<?php echo $companyDetails['logo'];?>" width="52" class="thumbs" />
<?php }else { ?>
...
<div style="border-bottom: 1px solid #ebebeb; padding-bottom: 10px; padding-left: 10px; width: 520px;">
...
Designation: <?php echo $memberDetails['designation'] ?> </div>
<br />
<div> Functional Area: <?php echo $memberDetails['name'] ?><br />
Company Type: <?php echo $memberDetails['company_type'] ?><br />
Telephone:
<?php if(!empty($memberDetails['telephone'])) { echo $memberDetails['telephone'];}else{ echo " -";} ?>
<br />
Fax:
<?php if(!empty($memberDetails['fax'])) { echo $memberDetails['fax']; }else{ echo " - ";} ?>
<br />
</div>
<br />
<div> Location: <span class="bluefont_lower"><?php echo $memberDetails['location'] ?>, <img src="flags/<?php echo strtolower($memberDetails['country_letter']) ?>.png"  /> <?php echo $memberDetails['country'] ?></span><br />
...
<?php if($count == 0 && $memberId <> $loggedmember) {?>
<a href="index.php?view=members&friendrequest=1&memberId=<?php echo $memberDetails['member_id']?>"> Add Contact /</a>
<?php }?>
...
<?php } ?>
<?php } ?>
/ <a href="index.php?view=member_list&from_page=showMember&memberId=<?php echo $memberDetails['member_id']?>">Share</a> </div>
</div></td>
</tr>
...
<a href="index.php?view=showMember&memberId=<?php echo $update['member_id']?>"><img src="gallery/photos/thumbs/<?php echo $update['member_photo'] ?>" width="52" class="thumbs"/></a>
<?php }else { ?>
<img src="gallery/photos/thumbs/default.png" width="52" height="52" class="thumbs" />
<?php }?>
</td></tr></table>
...
<li><a href="index.php?view=showMember&report=1&updateId=<?php echo $update['id']?>">Report</a></li>
</ul>
<div class="clear"></div>
</li>
</ul>
...
$group = $db->fetch($sql);?>
<div class="comment_box_wide"> <a href="index.php?view=showGroup&groupId=<?php echo $group['group_id']?>">
<?php if (!empty($group['group_image'])) {?>
<img src="gallery/logos/thumbs/<?php echo $group['group_image'];?>" height="52" width="52" class="thumbs" />
<?php }else {?>
...
<span class="caption">Website:</span><a href="http://<?php echo $group['website']?>" target="_blank"><?php echo $group['website']?></a> </div>
...
$event = $db->fetch($sql);?>
<div class="comment_box_wide"> <a href="index.php?view=showEvent&eventId=<?php echo $event['event_id']?>">
...
?>
<div class="comment_box_wide"> <a href="index.php?view=showEvent&eventId=<?php echo $eventMessage['event_id']?>">
...
?>
<div class="comment_box_wide"> <a href="index.php?view=showEvent&eventId=<?php echo $eventUpdateReply['event_id']?>">
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=tenderDetails&project_id=<?php echo $project['project_id']?>"> <?php echo $project['project_name']?> (<?php echo $project['project_ref_no']?>)</a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $comp_project['companyId']?>&projectId=<?php echo $comp_project['project_id']?>"><?php echo $comp_project['project_name']?> </a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $companyProjectMessage['companyId']?>&projectId=<?php echo $companyProjectMessage['project_id']?>"> <?php echo $companyProjectMessage['project_name']?></a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $projectUpdateReply['companyId']?>&projectId=<?php echo $projectUpdateReply['project_id']?>"><?php echo $projectUpdateReply['project_name']?></a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $projectInvite['companyId']?>&projectId=<?php echo $projectInvite['project_id']?>"><?php echo $projectInvite['project_name']?> </a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $projectRequest['companyId']?>&projectId=<?php echo $projectRequest['project_id']?>"> <?php echo $projectRequest['project_name']?> </a><br />
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=showProject&companyId=<?php echo $projectShortlist['companyId']?>&projectId=<?php echo $projectShortlist['project_id']?>"> <?php echo $projectShortlist['project_name']?> </a><br />
...
<div class="comment_box_wide"> <span class="caption">Job Title:</span><a href="index.php?view=jobDetails&jobId=<?php echo $jobOpening['job_opening_id']?>"> <?php echo $jobOpening['title']?></a><br />
...
$friend = $db->fetch($sql);?>
<div class="comment_box_wide"> <a href="index.php?view=showMember&memberId=<?php echo $friend['from_member_id']?>">
...
?>
<div class="comment_box_wide"> <span class="caption">Job Title:</span><a href="index.php?view=jobDetails&jobId=<?php echo $jobApplication['job_opening_id']?>"><?php echo $jobApplication['title']?></a><br />
...
?>
<div class="comment_box_wide"> <a href="index.php?view=moreUpdates&updateuId=<?php echo $memberUpdateReply['update_id']?>">
<table border="0" cellpadding="0" cellspacing="0" style="width:100px; float:left;"><tr><td style="padding-top:0px;border:hidden;">
...
$member = $db->fetch($sql);?>
<div class="comment_box_wide"> <a href="index.php?view=showMember&memberId=<?php echo $member['member_id']?>">
<table border="0" cellpadding="0" cellspacing="0" style="width:60px; float:left;"><tr><td style="padding-top:0px;border:hidden;">
...
<div class="comment_box_wide"> <span class="caption">Project Name:</span><a href="index.php?view=tenderReceivedDetails&tenderId=<?php echo $projectTender['tender_id']?>"><?php echo $projectTender['project_name'];?></a><br />
...
$project = $db->fetch($sql); 							
?>
<div class="comment_box_wide"> <span class="caption">Project Name:</span>
...
<div>
<?php	$sql="SELECT  ur.*,mem.first_name,mem.last_name,mem.member_photo,mem.company_id,comp.logo,
...
<div class="commentareawrapp replys">
...
<?php if( $reply['send_by'] == $loggedmember) {?>
<a  href="index.php?view=showMember&delete=1&memberId=<?php echo $update['member_id'] ?>&reply_id=<?php echo $reply['reply_id']?>"><span style="float: right;"><img class="icons" src="<?=IMAGEURL?>icons/close.gif" /></span><br />
</a>
<?php } ?>
<div style="padding-left:0px; float:left; width:100%; font-size:8pt; color: #999; background: url(images/icons/time.png) no-repeat 70px;">
...
<?php }else{?>
 <a href="javascript:void(0)" onclick="displayText('reply<?php echo $update['id'] ?>')" class="viewcomments">View all <?php echo $replyCount?> Comments</a>
<div>
...
<div class="messageareabox2">
<?php if( $reply['send_by'] == $loggedmember) {?>
<a  href="index.php?view=showMember&delete=1&memberId=<?php echo $update['member_id'] ?>&reply_id=<?php echo $reply['reply_id']?>"><span class="btn" style="float: right;"><img class="icons" src="<?=IMAGEURL?>icons/close.gif" /></span></a>
<?php } ?>
...
<div style="padding-left: 0;float:left;width:100%; font-size:8pt; color: #999; background: url(images/icons/time.png) no-repeat 70px;">
<?=compare_dates($reply['curunixtime'],$reply['createdunixtime'])?>
</div>
</div>
...
<div id="replytext<?php echo $update['id'] ?>" style="width: 488px; background-color:#F3F3F3; border:1px solid #EBEBEB; display:none; float:left; padding:5px 15px 10px 15px;"> 
<script type="text/javascript">
$('document').ready(function()
{
$('#formMember<?=$co?>').ajaxForm(  {
target: '#index',
success: function() {
...
<form method="post" id="formMember<?=$co++?>" action="">
...
<textarea name="comment" cols="55" rows="2" placeholder="Write a comment..." class="commentbox" id="replytextbox<?php echo $update['id'] ?>"></textarea>
<br />
<input type="image" value="Post" src="images/post-btn.png" style="padding-top: 5px;" width="46" height="23" onclick="hidebox('<?php echo $update['id'] ?>')" />
</form>
</div>
&nbsp; &nbsp; &nbsp; </td>
</tr>
